...
export default function CommentModal({ postId }: { postId: string }) {
  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className="rounded-md px-4 py-2 font-bold flex items-center gap-2"
      >
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="flex-grow">
                          <label
                            htmlFor="make-a-comment-message"
                            className="sr-only"
                          >
                            Insert message
                          </label>
                      ...
                      >
                        {!loading ? "Create Comment" : <Spinner />}
                      </button>
                    </>
                  )}
                </Dialog.Panel>
